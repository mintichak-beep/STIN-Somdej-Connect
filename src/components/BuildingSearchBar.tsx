...
export function BuildingSearchBar({
  id,
  value,
  onChange,
  placeholder = 'Search buildings by name, code, hospital...',
  viewMode,
  onViewModeChange,
}: BuildingSearchBarProps) {
  return (
    <div id={id || 'building-search-bar'} className="flex flex-col sm:flex-row gap-3 items-center justify-between w-full">
      {/* Search Input */}
